...
int main(int argc, char** argv){
  ...
  string serv_name = "/add_markers/CtrMarkerObj";

  // Define client to request service from add_markers_node.
  ros::ServiceClient client = n.serviceClient<add_markers::CtrMarkerObj>(serv_name);
  ...
  vector<Goal> goals{Goal(-6.0, -7.0, 1.0, "pickup"), Goal(-4.0, 3.0, 1.0, "dropoff")};
